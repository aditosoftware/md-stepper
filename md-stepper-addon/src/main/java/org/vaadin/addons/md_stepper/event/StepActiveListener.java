...
public interface StepActiveListener extends StepListener
{
   ...
   *
   * @param event The event containing additional information
   */
  ...
  class StepActiveEvent extends StepEvent
  {
     ...
     * @param step         The step related to this event
     * @param previousStep The step that was active before this step
