 ...
 * iteration listeners.
 *
 * @param <E> The type of the element to be iterated
 */
    ...
    implements ObservableIterator<E>
{
   ...
   *
   * @param event The event that will be triggered after the start
   */
   ...
   *
   * @param event The event that would be triggered if the iterator would not end
   */
   ...
   *
   * @param oldElement The current element before the iteration
   * @param newElement The current element after the iteration
   */
   ...
   *
   * @param event The event that caused the element change
   */
