 ...
 *
 * @param <E> The type of the elements of the iterator
 */
@FunctionalInterface
public interface NextListener<E> extends IterationListener
{
   ...
   *
   * @param event Event that contains information about the move to the next element
   */
   ...
   *
   * @param <E> The type of the element of the iterator
   */
