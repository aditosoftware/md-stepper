...
public class CircularList<E> extends ArrayList<E>
{
   ...
   *
   * @param list   The list to use to create the circular list
   * @param offset The element at the specified offset position will be the first element in the circular
